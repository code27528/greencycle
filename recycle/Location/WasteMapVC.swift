...
import CoreLocation
import MapKit
class customBin: NSObject, MKAnnotation{
...
class WasteMapVC: UIViewController, MKMapViewDelegate, CLLocationManagerDelegate {
    ...
    func locationManager(_ manager: CLLocationManager, didUpdateLocations locations: [CLLocation]) {
     ...
     func render(_ location: CLLocation){
         let sourceLocation = CLLocationCoordinate2D(latitude: location.coordinate.latitude,
          ...
          let destinationLocation = CLLocationCoordinate2D(latitude: 37.3231847, longitude: -122.081385)
          let sourcePin = customBin(pinTitle: "Your Location", pinSubTitle: "", location: sourceLocation)
          let destPin = customBin(pinTitle: "MLH Electronics", pinSubTitle: "Hours: 8am-4pm", location: destinationLocation)
